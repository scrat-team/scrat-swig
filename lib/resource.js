...
var DEFAULT_COMBO_SPLIT_LENGTH = Number.POSITIVE_INFINITY; // 正无穷
...
Resource.prototype.genComboURI = function(collect, url_length) {
  ...
  var len = typeof(url_length) != 'undefined' ? url_length : DEFAULT_COMBO_SPLIT_LENGTH; // best length 1920 = 1024 + 512 + 256 + 128
  var output = [];
  var combo = '';
  var temp;
